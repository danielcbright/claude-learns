# /eliminate-history - Review Past Elimination Sessions

**Syntax:** `/eliminate-history [--search query] [--limit N] [--outcome success|failure]`
...
# Filter by outcome
/eliminate-history --outcome success --limit 5

# View specific session details
/eliminate-history --session 2026-01-15-001
```
...
```
User: /eliminate-history --search "connection timeout redis"
