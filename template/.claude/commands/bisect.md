...
**Syntax:** `/bisect [bad_ref] [good_ref] [test_command]`
...
/bisect HEAD v1.2.0 "npm test -- --grep 'order processing'"
```
...
```
User: /bisect HEAD v2.1.0 "npm test -- --grep 'API returns correct status'"
...
Run `/eliminate` if you need to investigate why this change was made
